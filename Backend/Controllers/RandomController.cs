...
namespace Backend.Controllers
{
    ...
    public class RandomController : ControllerBase
    {
        ...
        public RandomController
            (
            [FromKeyedServices("singleton")] IRandomService randomServiceSingleton,
            [FromKeyedServices("scoped")] IRandomService randomServiceScoped,
            [FromKeyedServices("transient")] IRandomService randomServiceTransient,
            [FromKeyedServices("singleton")] IRandomService randomService2Singleton,
            [FromKeyedServices("scoped")] IRandomService randomService2Scoped,
            [FromKeyedServices("transient")] IRandomService randomService2Transient
            )
        {
